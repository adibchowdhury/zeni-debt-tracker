...
export const Route = createFileRoute("/_public/cookies")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How zeni collects, uses, and protects your personal information.",
      },
        ...
        <div className="mt-12 space-y-10 text-foreground">
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              We collect information you provide directly, such as your email address, debt details,
              and payment activity. We also collect usage data to improve the product.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Your information is used to provide debt tracking features, calculate your payoff
              timeline, and send progress updates. We never sell your data to third parties.
            </p>
          </section>

          <section>
            <h2 className="font-display text-2xl font-semibold">3. Data Storage & Security</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              ...
              Contact us at privacy@zeni.app for assistance.
            </p>
          </section>

          <section>
            <h2 className="font-display text-2xl font-semibold">5. Contact Us</h2>
            <p className="mt-3 leading-relaxed text-muted-foreground">
