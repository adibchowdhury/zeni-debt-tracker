...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Debtfree — Pay off debt faster, without the stress" },
      {
        name: "description",
        content:
          "A simple, motivating debt payoff coach. Track progress, see your debt-free date, and celebrate every win.",
      },
      { property: "og:title", content: "Debtfree — Pay off debt faster, without the stress" },
      {
      ...
      { name: "twitter:title", content: "Debtfree — Pay off debt faster, without the stress" },
      { name: "description", content: "Debt Dash helps you pay off debt faster with a motivating, mobile-first web app." },
      { property: "og:description", content: "Debt Dash helps you pay off debt faster with a motivating, mobile-first web app." },
      { name: "twitter:description", content: "Debt Dash helps you pay off debt faster with a motivating, mobile-first web app." },
