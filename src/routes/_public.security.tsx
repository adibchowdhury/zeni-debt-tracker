        ...
        <div className="mt-12 space-y-10 text-foreground">
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Zeni is built to help you stay motivated while paying off debt,
              and that only works if your data is protected. From day one, we’ve
              focused on building the app with modern security practices in
              place.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
              <li>
                Login and account access are handled through secure,
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
              ...
              <li>
                Row Level Security helps ensure users can only access their own
                data
              </li>
              <li>
              ...
              <li>
                Zeni does not connect directly to your bank accounts or access
                banking credentials
              </li>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
              ...
              <li>
                Browser-level protections that help control what content can run
                on the site
              </li>
            </ul>
            <p className="mt-3 leading-relaxed text-muted-foreground">
              These measures help make sure only trusted content runs in your
              browser.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Zeni is built on trusted infrastructure providers used by modern
              SaaS applications.
            </p>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-muted-foreground">
          ...
          <section>
            ...
            <p className="mt-3 leading-relaxed text-muted-foreground">
              Security isn’t a one-time setup. We continuously review and improve
              our security practices as the product evolves.
            </p>
          </section>
